...
- **`/v1/us/sec/companies/{identifier}/financials`** — adds the enrichment to each row in the paginated `data` array. Requires `?statement=` (see [SEC EDGAR](/datasets/sec-edgar)).
